...
class AnnouncementsWithPolls extends StatefulWidget {
  @override
  AnnouncementsWithPollsState createState() =>
      new AnnouncementsWithPollsState();
}

class AnnouncementsWithPollsState extends State<AnnouncementsWithPolls> {
